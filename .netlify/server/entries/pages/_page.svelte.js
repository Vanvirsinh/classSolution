import { c as create_ssr_component, d as each$1, f as add_attribute, e as escape, v as validate_component } from "../../chunks/index.js";
...
Swiper.use(modules);
const swiper_min = "";
const Swiper_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: "#home.svelte-1s0m98v{max-width:100%}.swiper-container.svelte-1s0m98v{overflow:hidden;width:100%}",
  map: null
};
const Swiper_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<section id="home" class="svelte-1s0m98v"><div class="swiper-container svelte-1s0m98v"><div class="swiper-wrapper home-slider">
            <div class="swiper-slide"><div class="item item-first"><div class="caption"><div class="container"><div class="col-md-6 col-sm-12"><h1>Heading for the first slide</h1>
                                <h3>Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Dignissimos rem, sint
                                    harum modi veniam labore.
                                </h3>
                                <a href="#about" class="section-btn btn btn-default smoothScroll">About Us</a></div></div></div></div></div>

            
            <div class="swiper-slide"><div class="item item-second"><div class="caption"><div class="container"><div class="col-md-6 col-sm-12"><h1>Heading for the second slide</h1>
                                <h3>Lorem, ipsum dolor sit amet consectetur
                                    adipisicing elit. Sequi ipsa quidem incidunt
                                    delectus id atque?
                                </h3>
                                <a href="#services" class="section-btn btn btn-default smoothScroll">Services</a></div></div></div></div></div>

            
            <div class="swiper-slide"><div class="item item-third"><div class="caption"><div class="container"><div class="col-md-6 col-sm-12"><h1>Heading for the Third slide</h1>
                                <h3>Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Nisi officia cupiditate
                                    placeat dolores ipsam saepe!
                                </h3>
                                <a href="#contact" class="section-btn btn btn-default smoothScroll">Reach out to us</a></div></div></div></div></div></div>
...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `
<section id="about"><div class="container"><div class="row"><div class="col-md-6 col-sm-12"><div class="about-info"><h2>Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit.
                    </h2>

                    <figure><span><i class="fa fa-users"></i></span>
                        <figcaption><h3>This is my About us</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Sint ipsa voluptatibus.
                            </p></figcaption></figure>

                    <figure><span><i class="fa fa-certificate"></i></span>
                        <figcaption><h3>This is also my About us</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Sint ipsa voluptatibus.
                            </p></figcaption></figure>

                    <figure><span><i class="fa fa-bar-chart-o"></i></span>
                        <figcaption><h3>And This is also</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Sint ipsa voluptatibus.
                            </p></figcaption></figure></div></div>

            <div class="col-md-offset-1 col-md-5 col-sm-12"><div class="entry-form"><div></div></div></div></div></div></section>`;
});
const Services = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let services = [
      ...
      subServices: [
        {
          ...
          description: "Lorem ipsum dolor sit amet,elit. Sint ipsa voluptatibus consectetur adipisicing."
        },
        {
          icon: "fa-check",
          title: "Sub-Services Heading",
    ...
    },
    {
      ...
      title: "This is my Second Service",
      description: "Lorem ipsum dolor sit consectetur adipisicing elit.",
      subServices: [
        {
          icon: "fa-book",
    ...
    },
    {
      ...
      title: "This is my Third Service",
      description: "Lorem ipsum dolor sit consectetur adipisicing elit.",
      subServices: [
        {
          icon: "fa-book",
  ...
  return `
<section id="services"><div class="container"><div class="row"><div class="col-md-12 col-sm-12"><div class="section-title"><h2>Services</h2>
                    <small>Upgrade your skills with Class Solution</small></div>

                <div class="owl-carousel owl-theme owl-courses services-container">${each$1(services, (service) => {
    return `<div class="col-md-4 col-sm-4"><div class="item"><div class="courses-thumb"><div class="services-img"><img${add_attribute("src", service.image, 0)} class="" alt=""></div>
                                    <div class="service-info"><h3>${escape(service.title)}</h3>
                                        <p>${escape(service.description)}</p>
                                        <div class="service-detail">${each$1(service.subServices, (subService) => {
      return `<figure><span><i class="${"fa " + escape(subService.icon, true)}"></i></span>
                                                    <figcaption><h3>${escape(subService.title)}</h3>
                                                        <p>${escape(subService.description)}
                                                        </p></figcaption>
                                                </figure>`;
    })}
                                        </div></div>
...
const css = {
  code: ".swiper-container.svelte-xyhmh8{overflow:hidden}",
  map: null
};
const Testimonial = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let reviews = [
    {
      userImage: "images/tst-image1.jpg",
      userName: "John Doe",
    ...
    {
      userImage: "images/tst-image2.jpg",
    ...
    {
      userImage: "images/tst-image3.jpg",
    ...
    {
      userImage: "images/tst-image4.jpg",
  ...
  $$result.css.add(css);
  return `
<section id="testimonial"><div class="container"><div class="row"><div class="col-md-12 col-sm-12"><div class="section-title"><h2>Student Reviews</h2>
                    <small>From around the world</small></div>
                <div class="swiper-container svelte-xyhmh8"><div class="swiper-wrapper">
                        ${each$1(reviews, (review) => {
    return `<div class="col-md-4 col-sm-4 swiper-slide"><div class="item"><div class="tst-image"><img${add_attribute("src", review.userImage, 0)} class="img-responsive" alt=""></div>
                                    <div class="tst-author"><h4>${escape(review.userName)}</h4>
                                        <span>${escape(review.userDesignation)}</span></div>
                                    <p>${escape(review.review)}</p>
                                    <div class="tst-rating">${each$1(review.stars, (star) => {
...
const Flash_svelte_svelte_type_style_lang = "";
...
<section id="contact"><div class="container"><div class="row"><div class="section-title"><h2>Contact us</h2>
                <small>We love conversations. Let us talk!</small></div>
            <div class="col-md-6 col-sm-12"><form id="contact-form"><h2>Send us an enquiry!</h2>
                    <div class="col-md-12 col-sm-12"><input type="text" class="form-control" placeholder="Enter full name" name="name" required${add_attribute("value", name, 0)}>

                        <input type="email" class="form-control" placeholder="Enter email address" name="email" required${add_attribute("value", email, 0)}>

                        <input type="phone" class="form-control" placeholder="Enter phone number" name="phone" required${add_attribute("value", phone, 0)}>

                        <textarea class="form-control" rows="6" placeholder="Tell us about your message" name="message" required>${escape("")}</textarea></div>

                    <div class="col-md-4 col-sm-12"><input type="submit" class="form-control" name="send message"${add_attribute("value", buttonStatus, 0)}></div></form></div>

            <div class="col-md-6 col-sm-12"><div class="contact-image"><img src="images/contact-image.jpg" class="img-responsive" alt="Smiling Two Girls"></div></div></div></div></section>`;
});
const PopUpForm_svelte_svelte_type_style_lang = "";
...
${validate_component(Testimonial, "Testimonial").$$render($$result, {}, {}, {})}
